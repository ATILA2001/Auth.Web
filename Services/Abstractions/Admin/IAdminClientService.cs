...
public interface IAdminClientService
{
    ...
    Task<int> CreateClientAsync(string clientId, string audience, IEnumerable<string> allowedUrls, string? defaultLandingPage, CancellationToken cancellationToken = default);
    Task UpdateClientAsync(int id, string clientId, string audience, IEnumerable<string> allowedUrls, string? defaultLandingPage, CancellationToken cancellationToken = default);
