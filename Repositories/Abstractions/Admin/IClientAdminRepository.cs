...
public interface IClientAdminRepository
{
    ...
    Task<int> CreateClientAsync(string clientId, string audience, IEnumerable<string> allowedUrls, string? defaultLandingPage, CancellationToken ct = default);
    Task UpdateClientAsync(int id, string clientId, string audience, IEnumerable<string> allowedUrls, string? defaultLandingPage, CancellationToken ct = default);
